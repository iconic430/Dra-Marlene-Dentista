    ...
    <section id="inicio" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left w-full">
        <div className="md:w-1/2 space-y-6 animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-lilac-700 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center md:justify-start">
             <a 
              ...
              className="bg-lilac-700 text-white px-12 py-6 rounded-full hover:bg-lilac-800 transition-all shadow-xl flex items-center justify-center gap-4 text-2xl font-bold group transform hover:-translate-y-1"
            >
              Agenda tu consulta <ArrowRight size={28} className="group-hover:translate-x-1 transition-transform" />
            </a>
          </div>
        </div>
      </div>
