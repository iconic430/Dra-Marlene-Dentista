...
const About = () => {
  ...
  return (
    <section id="sobre-mi" className="py-24 bg-white relative">
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-gold-100 rounded-br-full opacity-30 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8 order-1">
            <div>
              ...
              <h3 className="text-4xl font-serif font-bold text-lilac-700 mb-6">Dra. Marlene Inzunza Morales</h3>
          ...
          {/* Image Side - Now Second (placed after content) */}
          <div className="relative order-2">
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-10 -left-4 bg-white p-6 rounded-xl shadow-xl border border-lilac-100 max-w-xs hidden lg:block">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-lilac-700">Especialista en Ortodoncia</p>
                </div>
              </div>
            </div>
          </div>
