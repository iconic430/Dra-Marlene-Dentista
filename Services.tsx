    ...
    <section id="procedimientos" className="py-24 bg-lilac-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-lilac-700 mt-2 mb-4">Servicios Exclusivos</h2>
            ...
            <div className="inline-block bg-white p-6 rounded-xl shadow-md border-l-4 border-gold-500">
                <p className="text-lg text-gray-700">
                    ...
                    <a 
                      ...
                      className="text-lilac-700 font-bold hover:underline"
                    >
                      Agenda una valoración
                    </a> y diseñaremos un plan a tu medida.
                </p>
            </div>
        </div>
      </div>
