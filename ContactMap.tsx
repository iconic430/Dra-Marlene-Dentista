  ...
  return (
    <section id="contacto" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Contact and Map Box - Changed from bg-lilac-900 to bg-lilac-700 */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl bg-lilac-700 text-white">
          
          {/* Contact Info - Changed from bg-lilac-900 to bg-lilac-700 */}
          <div className="p-10 md:p-14 flex flex-col justify-center bg-lilac-700">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-gold-200">Visítanos</h2>
            <p className="text-lilac-50 mb-8 text-lg">
              Estamos ubicados en una zona accesible y segura. Agenda tu cita hoy mismo y comienza tu transformación.
            </p>

            <div className="space-y-6">
              <div className="flex items-start gap-4">
                {/* Icon background changed from bg-lilac-800 to bg-lilac-600 */}
                <div className="bg-lilac-600 p-3 rounded-lg">
                  <MapPin className="text-gold-400" size={24} />
                </div>
                <div>
                  <h4 className="font-bold text-lg">Dirección</h4>
                  <p className="text-lilac-50">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lilac-50">+52 667 389 0070</p>
                </div>
              </div>
               ...
               <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lilac-50">Lun - Vie: 10:00 AM - 7:00 PM<br/>Sáb: 10:00 AM - 3:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 bg-transparent border-2 border-lilac-300 text-lilac-50 font-bold py-3 px-8 rounded-full hover:bg-lilac-600 transition-all shadow-lg transform hover:-translate-y-1"
              >
